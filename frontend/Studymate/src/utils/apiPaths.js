...
export const API_PATHS = {
  ...
  FLASHCARDS: {
    ...
    REVIEW_FLASHCARD: (setId,cardId) => `/api/flashcards/${setId}/review/${cardId}`,
    GET_FLASHCARD_BY_ID: (setId) => `/api/flashcards/set/${setId}`,
    TOGGLE_STAR: (setId,cardId) => `/api/flashcards/${setId}/star/${cardId}`,
